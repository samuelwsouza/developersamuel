<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $result = mysqli_query($mysql, "INSERT INTO usuarios(nome, email, mensagem) 
...
<html lang="pt-BR">
  <head>
    ...
    <meta
      name="viewport"
      content="width=device-width, initial-scale=1.0, maximum-scale, maximum-scale=1.0"
    />
    <!-- CSS Files -->
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <header>
      <nav class="container">
        <a href="#" class="logo">samuel<span>dev</span></a>
        <div class="links">
          <ul>
            <li>
    ...
    <main>
      <section class="showcase-area" id="home">
        ...
        <div class="container">
          <div class="showcase-info">
            <h3 class="sub-heading">Desenvolvedor Front-End Júnior</h3>
            <h1 class="heading">Samuel Willians de Souza</h1>
            <p class="text">Livre no mercado, estou a disposição.</p>
            <div class="cta">
              <a href="mailto:samuelwillliansdesouza15@gmail.com" class="btn"
                >Meu contato</a
              >
              <a href="assets/samuelCV.pdf" download class="btn secondary-btn"
                >Baixar Currículo</a
              >
            </div>
          </div>
          <div class="showcase-image">
            <img src="assets/samueldevsemfundo.png" class="person" alt="Example" />
      ...
      <section class="about section" id="sobre">
        ...
        <div class="container">
          <div class="about-grid">
            ...
            <div class="about-card">
              ...
              >
                ...
                <g class="st2">
                  <path
                    d="M356.28,376.31l15.59-15.59l60.68,60.68l-15.59,15.59L356.28,376.31z"
                  ></path>
                </g>
              </svg>
              <h3>Resiliente</h3>
          ...
          <div class="about-info">
            <h3 class="sub-heading">Sobre mim</h3>
            <h1 class="heading">O que possuo?</h1>
            <p class="text">
              Acredito que possuo muitas habilidades para benefício daquilo que
              estou comprometido. Deve se ter um bom relacionamento interpessoal
              para que haja um trabalho em equipe bem efetivo. Não tenho dúvidas
              que uma boa comunicação faz fluir muito bem as tarefas diárias, traz
              clareza e assertividade. É necessário obter uma boa capacidade analítica
              e resolução de problemas eficaz.
        ...
        <div class="container">
          <div class="skills-box">
            <div class="box-heading">
              <h3 class="sub-heading">Minhas habilidades</h3>
              <h1 class="heading">Linguagens, tecnologias</h1>
              <div class="box-desc">
                <p class="text">
                  Bom, iniciei meus estudos com 16 anos após sentir um enorme
                  interesse pela programação. Começei estudando Front-End e
                  assim me aperfeiçoando com HTML5, CSS3 e JavaScript. Para cada
                  vez estar mais preparado para o mercado de trabalho procurei
                  iniciar cursos sobre ReactJS, PHP, MySQL, SQL Server e os
                  frameworks Bootstrap e Materialize. Sempre buscando o domínio
                  de cada linguagem de programação e tecnologia. Para minha
                  capacitação, será introduzido meus projetos para meu
                  portfolio.
                </p>
                <a
                  href="https://github.com/samukawsouza"
                  target="_blank"
                  class="btn github"
                  >GitHub</a
                >
                <a
                  href="https://www.linkedin.com/in/samuel-willians-de-souza-444a6a1b4/"
                  target="_blank"
                  class="btn linkedin"
                  >LinkedIn</a
                >
            ...
            <div class="skills-wrap">
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/html5circle.png" alt="" />

                  <h2 class="image-tech html">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">HTML5</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/css3circle.png" alt="" />

                  <h2 class="image-tech css">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">CSS3</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/js.png" alt="" />

                  <h2 class="image-tech js">
                    <!-- <img /> -->
                  </h2>
                </div>
              ...
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/phplogo.jpg" alt="" />

                  <h2 class="image-tech php">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">PHP</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/reactlogoatual.png" alt="" />

                  <h2 class="image-tech react">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">ReactJS</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/mysql.png" alt="" />

                  <h2 class="image-tech mysql">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">MySQL</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/typescriptlogo.png" alt="" />

                  <h2 class="image-tech mysql">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">TypeScript</div>
              </div>
              <div class="skill">
                <div class="sk-progress">
                  <img src="./assets/sqlserverlogo.png" alt="" />

                  <h2 class="image-tech mysql">
                    <!-- <img /> -->
                  </h2>
                </div>
                <div class="sk-title">SQL Server</div>
              </div>
      ...
      <section class="services section" id="services">
        <div class="container">
          <div class="services-info">
            <h3 class="sub-heading">Meus serviços</h3>
            <h1 class="heading">Livre no mercado</h1>
            <p class="text">Ofereço meu serviço sendo capaz de prestar
              minhas obrigações e atuando no desenvolvimento daquilo que 
              me foi proposto.
            </p>  
              <div class="titles">
                <div class="tt">
                  <h2 class="number"><span data-target="19">0</span></h2>
                  <h5>Anos</h5>
                </div>
                <div class="tt">
                  <h2 class="number"><span data-target="6">0</span>+</h2>
                  <h5>Projetos</h5>
                </div>
                <div class="tt">
                  <h2 class="number"><span data-target="3">0</span>+</h2>
                  <h5>Cursos</h5>
                </div>
              </div>
              <div class="cta">
                <a href="mailto:samuelwillliansdesouza15@gmail.com" class="btn">Me contrate</a>
                 <a href="assets/samuelCV.pdf" download class="btn secondary-btn">Baixar CV</a>
              </div>
          </div>
          <div class="services-grid">
            <div class="srv-card">
              <div class="card-desc">
                <h3>Aprendiz (Auxiliar)</h3>
                <p class="text">Trabalhei 1 ano e 6 meses como Aprendiz
                  no supermercado Atacado e Varejo Bem-Barato afim de obter meu primeiro
                  contato com o mercado de trabalho - 2021/2022
                </p>
              </div>
              <a href="#" class="btn secondary-btn">Saiba mais</a>
            </div>
             <div class="srv-card">
              <div class="card-desc">
                <h3>Desenvolvedor Front-End</h3>
                <p class="text">Para de fato colocar a mão na massa e mostrar meu potencial como
                  programador, estou disponível no Workana (plataforma freelancer) para desenvolver
        ...
        <div class="container">
          <div class="portfolio-header">
            <div class="portfolio-title">
              ...
              <h1 class="heading">Últimos projetos</h1>
            </div>
            <div class="filter-btns">
              <button class="filter-btn" data-filter="all">Todos</button>
              <button class="filter-btn" data-filter=".product">Produto</button>
              <button class="filter-btn" data-filter=".inter">Interação</button>
              <button class="filter-btn" data-filter=".web">App Web</button>
            </div>
          </div>
          <div class="portfolio-gallery">
            <div class="mix port-card inter">
              <div class="port-image">
                <img src="assets/port1.jpg" alt="">
                <div class="port-overlay">
                  <span class="port-icon zoom-icon">
                    <i class="uil uil-search-plus"></i>
                  </span>
                  <a href="#" class="port-icon">
                    <i class="uil uil-link-h"></i>
                  </a>
                </div>
              </div>
              <div class="port-desc">
                <h3>NodeJS Back-End</h3>
                <a href="#" class="btn secondary-btn sm">Leia mais</a>
              </div>
            </div>
             <div class="mix port-card web">
              <div class="port-image">
             ...
             <div class="mix port-card product">
              <div class="port-image">
      ...
      <section class="contact section" id="home">
        <div class="container">
          ...
          <div class="contact-info">
            <h3 class="sub-heading">Me contate</h3>
            <h1 class="heading">Vamos trabalhar juntos!</h1>
            <p class="text">
              Sentiu interesse? <br> Mande uma mensagem para mim, reponderei
              assim que for possível. Estou disposto a entrar em processos seletivos
              e entrevistas.
            </p>
            <span style="color: purple;">Whatsapp - (11) 98383-0759</span>
            <a href="mailto:samuelwilliansdesouza15@gmail.com" class="mail">samuelwilliansdesouza15@gmail.com 
            <i class="uil uil-arrow-right"></i></a>
          </div>

          <form action="index.php" method="POST" class="contact-form">
            <h3>Me envie uma mensagem por aqui <i class="uil uil-message"></i></h3>
            <input type="text" class="form-input" placeholder="Seu nome.." id="nome" name="nome" required>
            <input type="email" class="form-input" placeholder="Seu e-mail.." id="email" name="email" required>
            <textarea class="form-input" placeholder="O que deseja me dizer?" id="mensagem" name="mensagem" required></textarea>
      ...
      <section class="subscription section" id="contato">
        <div class="container">
          <img src="./assets/map.png" class="map">
          <div class="sub-box">
            <div class="sub-info">
              <h3 class="sub-heading">Minha Newsletter</h3>
              <h1 class="heading">Meu projeto na sua inbox</h1>
              <p class="text">
                Estarei enviando para o e-mail cadastrado de vocês cada projeto que for
                desenvolvido por mim, esteja ciente dos meus trabalhos como desenvolvedor.
              </p>
            </div>
    ...
    <footer>
      <div class="container">
         <a href="#" class="logo">samuel<span>dev</span></a>
         <p class="text">&copy; Copyright 2023. Todos direitos reservados</p>
